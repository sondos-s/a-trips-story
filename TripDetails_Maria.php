...
<body>
    ...
    <div style="margin-top: 2000px; margin-left: 0">
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                if (isset($_SESSION['user_id'])) {
                    ...
                    if (strtotime($tripData['tripDate'] . ' ' . $tripData['tripTime']) > $currentTimestamp) {
                        ...
                        if ($availableSpots == 0) {
                            echo "<p style='color: red;'>This trip is fully booked.</p>";
                        } elseif ($availableSpots == 1) {
                            echo "<p style='color: red;'>Only 1 spot left!</p>";
                        } elseif ($availableSpots <= 5) {
                            echo "<p style='color: red;'>Only {$availableSpots} spots left!</p>";
                        } else {
                            echo "<p style='color: black;'>{$availableSpots} available spots.</p>";
                        }
                    } else {
                        // This is not an upcoming trip, you can display a message indicating that it's in the past
                        echo "<p style='color: gray;'>This trip has already taken place.</p>";
                    }
                } else {
